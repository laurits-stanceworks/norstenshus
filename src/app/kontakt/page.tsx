    ...
    <>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="mx-auto max-w-5xl grid md:grid-cols-2 gap-16">
          {/* Form */}
          <div>
            <h2 className="text-[#262742] text-2xl font-light mb-8">Send os en besked</h2>
            <ContactForm />
          </div>

          {/* Info */}
          <div>
            <h2 className="text-[#262742] text-2xl font-light mb-8">Find os</h2>
            <div className="space-y-6 mb-10">
              ...
              <div className="flex gap-4">
                <Phone size={20} className="text-[#CA9665] shrink-0 mt-1" strokeWidth={1.5} />
                <div>
                  <p className="font-medium text-[#262742] mb-1">Telefon</p>
                  <a
                    href="tel:+4582303234"
                    className="text-[#6b6b7a] text-sm hover:text-[#CA9665] transition-colors"
                  >
                    82 30 32 34
                  </a>
                </div>
              ...
              <div className="flex gap-4">
                <Mail size={20} className="text-[#CA9665] shrink-0 mt-1" strokeWidth={1.5} />
                <div>
                  <p className="font-medium text-[#262742] mb-1">Email</p>
                  <a
            ...
            <div className="bg-[#f5f4f0] rounded-lg p-8">
              <p className="text-[#262742] font-medium mb-2">Åbningstider</p>
              <p className="text-[#6b6b7a] text-sm">
