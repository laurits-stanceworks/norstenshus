    ...
    <>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="mx-auto max-w-5xl grid md:grid-cols-2 gap-16">
          {/* Form */}
          <div>
            <h2 className="text-[#010f12] text-2xl font-light mb-8">Send os en besked</h2>
            <ContactForm />
          </div>

          {/* Info */}
          <div>
            <h2 className="text-[#010f12] text-2xl font-light mb-8">Find os</h2>
            <div className="space-y-6 mb-10">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-medium text-[#010f12] mb-1">Telefon</p>
                  <a
                    href="tel:+4582303234"
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="font-medium text-[#010f12] mb-1">Email</p>
                  <a
            ...
            <div className="bg-[#fffdeb] rounded-lg p-8">
              <p className="text-[#010f12] font-medium mb-2">Åbningstider</p>
              <p className="text-[#6b6b7a] text-sm">
